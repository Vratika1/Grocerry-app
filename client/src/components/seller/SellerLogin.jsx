  ...
  return !isSeller && (
    <>
      ...
      <form onSubmit={onSubmitHandler} className='min-h-screen flex items-center text-sm text-gray-600'>
        <div className='flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80 sm:min-w-88 rounded-lg sgadow-xl border border-gray-200'>
            ...
            <button type="submit" className='bg-primary text-white w-full py-2 rounded-md cusrsor-pointer mt-4'>Login</button>
        </div>
